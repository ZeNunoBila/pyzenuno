...
#{"lat":19.539,"lon":-155.578}}
	def __init__(self,dt,site='uccle'):				
		#!!!!! Belgium is UTC + 2 in summer and UTC + 1 in winter
		dict_coords = {"uccle":{"lat":50.79679,"lon":4.356953,"tz":2},"mont-rigi":{"lat":50.51127,"lon":6.074233},"mlo":{"lat":19.539,"lon":-155.578,"tz":-10},"izo":{"lon":-16.499,"lon":28.308,"tz":0},"jung":{"lat":46.541831166,"lon": 7.97416277,"tz":2}}
		self.lat = dict_coords[site]["lat"]
		self.lon = dict_coords[site]["lon"]
		self.dt = dt
		self.tz = dict_coords[site]["tz"] # 0 if time is given in UTC
